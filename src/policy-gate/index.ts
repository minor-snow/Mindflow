import type { ProposedAction, PolicyDecision } from "../types/index.js";

const DANGEROUS_ACTIONS: ReadonlySet<string> = new Set([
  "delete_task",
  "force_override_state",
  "skip_policy_gate",
]);

const FORBIDDEN_MUTATIONS: ReadonlySet<string> = new Set([
  "modify_event_log",
  "rewrite_event",
  "delete_event",
]);
